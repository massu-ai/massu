...
import { existsSync as existsSync4, readFileSync as readFileSync3, readdirSync, unlinkSync, writeFileSync as writeFileSync2 } from "fs";
...
function readFailureContextFiles() {
  ...
  try {
    ...
    for (const file of files) {
      try {
        context += " " + readFileSync3(join(dir, file), "utf-8");
      } catch {
      }
    }
  } catch {

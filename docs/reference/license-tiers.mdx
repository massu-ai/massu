...
### Pro Tier (47 additional tools)

Everything in Free, plus advanced memory, knowledge, analytics, cost, prompt analysis, validation, ADR, observability, documentation, Python intelligence, and MCP bridge tools.
...
| **MCP Bridge** | `mcp_servers`, `mcp_tools`, `mcp_call`, `mcp_status` | Cross-project tool mesh: list servers, discover tools, call tools on external MCP servers, check connection health |

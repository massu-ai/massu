...
Massu AI includes 20 workflow commands across 5 categories -- Implementation Workflow, Development Tools, Code Review & Verification, Diagnostics & Utilities, and Productivity & Insights -- that enforce a verification-first approach to AI-assisted development. Every claim of completion requires proof. Every removal requires negative verification. Every plan item gets tracked.

 ...
 * `/Users/operator/example-project/docs/plans/2026-04-26-massu-stack-aware-command-templates.md`.
 *
...
describe('pickVariant — VARIANT-01..10', () => {
  ...
  it('VARIANT-05: two competing variants → first declared in framework.languages wins', () => {
    ...
    // example-project-shaped: python declared BEFORE swift in the languages block.
    const fw = emptyFramework({
      type: 'multi',
      primary: 'typescript',
      languages: {
  ...
  it('VARIANT-10: passthrough-only language (framework.swift) participates in resolution', () => {
    ...
    // example-project-shaped: typescript primary; languages contains [typescript]; NO swift in languages.

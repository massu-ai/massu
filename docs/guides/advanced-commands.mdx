...
description: "Guide to debugging, refactoring, and advanced development commands"
---
...
This executes VR-BUILD, VR-TYPE, VR-TEST, VR-PATTERN, and all other registered verification types, producing a consolidated pass/fail report.
...
Use this for incremental pushes during active development; use `/massu-push` before merging to main.

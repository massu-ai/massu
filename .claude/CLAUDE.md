...
>
> **`/Users/ekoultra/massu/`** maps to **`https://github.com/massu-ai/massu`** —
...
>
> 1. Verify the path is in `PUBLIC_MANIFEST.md` (in `/Users/ekoultra/massu-internal/scripts/`).
...
>    auto-memory.
>
> **Forbidden paths in this repo** (must go to `/Users/ekoultra/massu-internal/` instead):
...
> `/Users/ekoultra/massu-internal/docs/incidents/2026-05-06-public-repo-leak-playbook.md`.
>
...
> `/Users/ekoultra/massu-internal/` and syncing forward.**

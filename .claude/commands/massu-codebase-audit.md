...
grep -rn 'requirePlan' /Users/operator/massu-internal/website/src/app/ --include="*.ts" --include="*.tsx" | wc -l
# Auth stubs
grep -rn 'TODO\|FIXME\|stub' /Users/operator/massu-internal/website/src/ --include="*.ts" | grep -i auth | head -20
```

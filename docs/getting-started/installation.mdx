...
Re-deploys all 59 slash commands into `.claude/commands/` without running the full init process. Useful after updating `@massu/core` to get the latest command definitions.

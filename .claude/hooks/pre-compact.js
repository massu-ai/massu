...
// src/config.ts
var DomainConfigSchema = external_exports.object({
  name: external_exports.string().default("Unknown"),
  routers: external_exports.array(external_exports.string()).default([]),
  pages: external_exports.array(external_exports.string()).default([]),
  tables: external_exports.array(external_exports.string()).default([]),
  allowedImportsFrom: external_exports.array(external_exports.string()).default([])
});
var PatternRuleConfigSchema = external_exports.object({
  pattern: external_exports.string().default("**"),
  rules: external_exports.array(external_exports.string()).default([])
});
var CostModelSchema = external_exports.object({
  input_per_million: external_exports.number(),
  output_per_million: external_exports.number(),
  cache_read_per_million: external_exports.number().optional(),
  cache_write_per_million: external_exports.number().optional()
});
var AnalyticsConfigSchema = external_exports.object({
  quality: external_exports.object({
    weights: external_exports.record(external_exports.string(), external_exports.number()).default({
      bug_found: -5,
      vr_failure: -10,
      incident: -20,
      cr_violation: -3,
    ...
    categories: external_exports.array(external_exports.string()).default(["security", "architecture", "coupling", "tests", "rule_compliance"])
  }).optional(),
  cost: external_exports.object({
    models: external_exports.record(external_exports.string(), CostModelSchema).default({}),
    currency: external_exports.string().default("USD")
  }).optional(),
  prompts: external_exports.object({
    success_indicators: external_exports.array(external_exports.string()).default(["committed", "approved", "looks good", "perfect", "great", "thanks"]),
    failure_indicators: external_exports.array(external_exports.string()).default(["revert", "wrong", "that's not", "undo", "incorrect"]),
    max_turns_for_success: external_exports.number().default(2)
  }).optional()
}).optional();
...
var GovernanceConfigSchema = external_exports.object({
  audit: external_exports.object({
    formats: external_exports.array(external_exports.string()).default(["summary", "detailed", "soc2"]),
    retention_days: external_exports.number().default(365),
    auto_log: external_exports.record(external_exports.string(), external_exports.boolean()).default({
      code_changes: true,
  ...
  validation: external_exports.object({
    realtime: external_exports.boolean().default(true),
    checks: external_exports.record(external_exports.string(), external_exports.boolean()).default({
      rule_compliance: true,
      import_existence: true,
      naming_conventions: true
    }),
    custom_patterns: external_exports.array(CustomPatternSchema).default([])
  }).optional(),
  adr: external_exports.object({
    detection_phrases: external_exports.array(external_exports.string()).default(["chose", "decided", "switching to", "moving from", "going with"]),
    template: external_exports.string().default("default"),
    storage: external_exports.string().default("database"),
    output_dir: external_exports.string().default("docs/adr")
  }).optional()
}).optional();
var SecurityPatternSchema = external_exports.object({
  pattern: external_exports.string(),
  severity: external_exports.string(),
...
var SecurityConfigSchema = external_exports.object({
  patterns: external_exports.array(SecurityPatternSchema).default([]),
  auto_score_on_edit: external_exports.boolean().default(true),
  score_threshold_alert: external_exports.number().default(50),
  severity_weights: external_exports.record(external_exports.string(), external_exports.number()).optional(),
  restrictive_licenses: external_exports.array(external_exports.string()).optional(),
  dep_alternatives: external_exports.record(external_exports.string(), external_exports.array(external_exports.string())).optional(),
  dependencies: external_exports.object({
    package_manager: external_exports.string().default("npm"),
    blocked_packages: external_exports.array(external_exports.string()).default([]),
    preferred_packages: external_exports.record(external_exports.string(), external_exports.string()).default({}),
    max_bundle_size_kb: external_exports.number().default(500)
  }).optional()
}).optional();
var TeamConfigSchema = external_exports.object({
  enabled: external_exports.boolean().default(false),
  sync_backend: external_exports.string().default("local"),
  developer_id: external_exports.string().default("auto"),
  share_by_default: external_exports.boolean().default(false),
  expertise_weights: external_exports.object({
    session: external_exports.number().default(20),
    observation: external_exports.number().default(10)
  }).optional(),
  privacy: external_exports.object({
    share_file_paths: external_exports.boolean().default(true),
    share_code_snippets: external_exports.boolean().default(false),
    share_observations: external_exports.boolean().default(true)
  }).optional()
}).optional();
var RegressionConfigSchema = external_exports.object({
  test_patterns: external_exports.array(external_exports.string()).default([
    "{dir}/__tests__/{name}.test.{ext}",
    "{dir}/{name}.spec.{ext}",
    "tests/{path}.test.{ext}"
  ]),
  test_runner: external_exports.string().default("npm test"),
  health_thresholds: external_exports.object({
    healthy: external_exports.number().default(80),
    warning: external_exports.number().default(50)
  }).optional()
}).optional();
var CloudConfigSchema = external_exports.object({
  enabled: external_exports.boolean().default(false),
  apiKey: external_exports.string().optional(),
  endpoint: external_exports.string().optional(),
  sync: external_exports.object({
    memory: external_exports.boolean().default(true),
    analytics: external_exports.boolean().default(true),
...
var PathsConfigSchema = external_exports.object({
  source: external_exports.string().default("src"),
  aliases: external_exports.record(external_exports.string(), external_exports.string()).default({ "@": "src" }),
  routers: external_exports.string().optional(),
  routerRoot: external_exports.string().optional(),
  pages: external_exports.string().optional(),
  middleware: external_exports.string().optional(),
  schema: external_exports.string().optional(),
  components: external_exports.string().optional(),
  hooks: external_exports.string().optional()
});
var RawConfigSchema = external_exports.object({
  project: external_exports.object({
    name: external_exports.string().default("my-project"),
    root: external_exports.string().default("auto")
  }).default({ name: "my-project", root: "auto" }),
  framework: external_exports.object({
    type: external_exports.string().default("typescript"),
    router: external_exports.string().default("none"),
    orm: external_exports.string().default("none"),
    ui: external_exports.string().default("none")
  }).default({ type: "typescript", router: "none", orm: "none", ui: "none" }),
  paths: PathsConfigSchema.default({ source: "src", aliases: { "@": "src" } }),
  toolPrefix: external_exports.string().default("massu"),
  dbAccessPattern: external_exports.string().optional(),
  knownMismatches: external_exports.record(external_exports.string(), external_exports.record(external_exports.string(), external_exports.string())).optional(),
  accessScopes: external_exports.array(external_exports.string()).optional(),
  domains: external_exports.array(DomainConfigSchema).default([]),
  rules: external_exports.array(PatternRuleConfigSchema).default([]),
...
function getConfig() {
  ...
  if (existsSync(configPath)) {
    ...
    rawYaml = (0, import_yaml.parse)(content) ?? {};
  }
...
function buildSnapshotSummary(observations, prompts) {
  ...
  const planProgress = { snapshot_type: "pre_compact" };
  for (const o of observations) {

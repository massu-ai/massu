...
ALLOWED_PATTERNS=(
  ...
  '^\.github/rulesets/'
  # Dependabot (2026-08-07). dependabot.yml is GENERATED by sync-public.sh from
  # the internal `.github/dependabot.public.yml`, same `.public.<ext>` rename
  # pattern as ci.yml and main-branch.json. It carries no private content: two
  # ecosystem blocks and a weekly schedule. Exact-file match, not a directory
  # glob — `^\.github/` wholesale would also admit anything else dropped there.
